const CONTRIBUTERS = [
    ...
    },
    {
        ...
        <script src="https://cdn.lordicon.com//libs/frhvbuzj/lord-icon-2.0.2.js"></script>
        <div class="text-center">
            <lord-icon src="https://cdn.lordicon.com/uxtcmjmu.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon>     
                Caffenating 
            <lord-icon src="https://cdn.lordicon.com/uxtcmjmu.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:25px;height:25px"></lord-icon>     
            <br />
            <lord-icon src="https://cdn.lordicon.com/wxnxiano.json" trigger="loop" colors="primary:#121331,secondary:#2516c7" style="width:25px;height:25px"></lord-icon>
            ...
            <lord-icon src="https://cdn.lordicon.com/wxnxiano.json" trigger="loop" colors="primary:#121331,secondary:#2516c7" style="width:25px;height:25px"></lord-icon>
            <br />
            <lord-icon src="https://cdn.lordicon.com/anihkfxp.json" trigger="loop" style="width:32px;height:32px"></lord-icon>
                Using 
            <lord-icon src="https://cdn.lordicon.com/anihkfxp.json" trigger="loop" style="width:32px;height:32px"></lord-icon>
            <br />
            <lord-icon src="https://cdn.lordicon.com/jpdtnwas.json" trigger="loop" colors="primary:#121331,secondary:#e88c30" style="width:25px;height:25px"></lord-icon>
